...
import foam.boskoi.android.data.BlogData;
...
public class BoskoiService extends Service {
	...
	public static void loadSettings(Context context) {
		final SharedPreferences settings = context.getSharedPreferences(
				PREFS_NAME, 0);
		savePath = "/data/data/foam.boskoi.android/files/";// settings.getString("savePath","/data/data/com.boskoi.android.app/files/");
