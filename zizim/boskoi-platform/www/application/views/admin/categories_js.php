...
// Categories JS
function fillFields(id, parent_id, category_title, category_title_nl, category_title_la, category_description, category_color, locale)
{
	show_addedit();
	...
	$("#category_title_nl").attr("value", unescape(category_title_nl));
	$("#category_title_la").attr("value", unescape(category_title_la));
}
