			...
			<div class="bg">
				...
				<div class="tabs">
					...
					<div class="tab" id="addedit" style="display:none">
						...
						<div class="tab_form_item">
							<strong><?php echo Kohana::lang('ui_main.category_name_nl');?>:</strong><br />
							<?php print form::input('category_title_nl', $form['category_title_nl'], ' class="text"'); ?>
						</div>
						<div class="tab_form_item">
							<strong><?php echo Kohana::lang('ui_main.category_name_la');?>:</strong><br />
							<?php print form::input('category_title_la', $form['category_title_la'], ' class="text"'); ?>
						</div>
						<div class="tab_form_item">
							...
							<table class="table">
								...
								<tbody>
									...
									foreach ($categories as $category)
									{
										...
										$category_title_nl = $category->category_title_nl;
										$category_title_la = $category->category_title_la;
...
<li><a href="javascript:catAction('d','DELETE','<?php echo(rawurlencode($category_id)); ?>')" class="del"><?php echo Kohana::lang('ui_main.delete');?></a></li>
										...
										foreach ($category->children as $child)
										{
											...
											$category_title_nl = $child->category_title_nl;
											$category_title_la = $child->category_title_la;
