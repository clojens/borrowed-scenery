                ...
                <div class="side-bar-module rounded shadow">
                    ...
                    <div class="side-bar-content">
                        <ul class="sub-nav-links">
                        	<li><a href="#">Nothing to Install</a></li>
                            <li><a href="#">Interactive Map</a></li>
                            <li><a href="#">Dynamic Timeline</a></li>
                            <li><a href="#">Export Data via GeoRSS, CSV or API</a></li>
                            <li><a href="#">Real Time Data Tracking</a></li>
                        </ul>
                    </div>
                </div>-->
            </div>
