...
package foam.boskoi.android;

import foam.boskoi.android.R;
...
public class ListIncidentTextView extends LinearLayout{
	...
	public void initComponent( Context context, ListIncidentText listText ) {
		...
		thumbnail.setLayoutParams(new TableRow.LayoutParams(
				60, TableRow.LayoutParams.WRAP_CONTENT));	
		tblRow.addView(thumbnail);
	
		
		title = new TextView( context);
		
		title.setTextColor(Color.parseColor(context.getText(R.string.title_string).toString()));//Color.rgb(0,157, 140));
		...
		//change color if text is not Verified
		if( listText.getStatus().equals("Verified")) {
			status.setTextColor(Color.parseColor(context.getText(R.string.verified_string).toString()));//Color.rgb(41, 142, 40));
		} else {
			status.setTextColor(Color.parseColor(context.getText(R.string.notverified_string).toString()));//Color.rgb(237, 0, 0));
		}
	...
	public void setStatus( String status ) {
		...
		if( status.equals("Verified")) {
			this.status.setTextColor(Color.parseColor(this.getContext().getText(R.string.verified_string).toString()));//Color.rgb(41, 142, 40));
		} else {
			this.status.setTextColor(Color.parseColor(this.getContext().getText(R.string.notverified_string).toString()));//Color.rgb(237, 0, 0));
		}
