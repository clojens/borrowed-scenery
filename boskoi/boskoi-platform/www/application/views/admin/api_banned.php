...
<div class="bg">
	...
	<div class="tabs">
		...
		<div class="tab">
			<ul>
				<li><a href="#" onclick="apiBannedAction('d','UNBAN', '');"><?php echo Kohana::lang('ui_admin.api_unban')?></a></li>
				<li><a href="#" onclick="apiBannedAction('x','UNBAN ALL ', '000');"><?php echo Kohana::lang('ui_admin.api_unban_all')?></a></li>
			</ul>
		</div>
	</div> 
	<?php
