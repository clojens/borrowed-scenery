<?php
	...
	'profile_notify' => 'Выберите Да для получения оповещений через Email новых сообщений или комментарий которые были выставлены на веб сайте',
	...
	'settings_allow_feed' => 'Разрешить добавление новостной ленты RSS на главной странице.',
	...
	'settings_server_host' => 'Местоположение сообщений',
	'settings_server_password' => ' Пароль для Email адреса',
	'settings_server_port' => 'Порт для получения доступа к входящим сообщениям через Email',
	'settings_server_ssl_support' => 'Требуется для более безопасного обмена сообщениями',
	'settings_server_type' => 'Технология получения доступа к входящим сообщениям через Email',
